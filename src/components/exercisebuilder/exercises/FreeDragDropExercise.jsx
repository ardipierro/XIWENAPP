                    ...
                    return (
                      ...
                      >
                        ...
                        {showCorrectness && (
                          <>
                            {isCorrectCategory ? (
                              <Check size={16} className="flex-shrink-0" style={{ color: 'var(--color-success)' }} strokeWidth={2} />
                            ) : (
                              <X size={16} className="flex-shrink-0" style={{ color: 'var(--color-error)' }} strokeWidth={2} />
                            )}
                          </>
                        )}
                      </div>
