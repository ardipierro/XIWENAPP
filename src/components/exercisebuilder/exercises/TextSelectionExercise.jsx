      ...
      parts.push(
        <span
          ...
          className={`
            ...
            ${!showFeedback ? 'hover:bg-gray-100 dark:hover:bg-blue-900/30' : ''}
    ...
    >
      <div className="space-y-6">
        ...
        {selectedWord && !showFeedback && (
          <div className="p-4 bg-gray-50 dark:bg-gray-800/20 border border-gray-300 dark:border-gray-600 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-lg font-medium text-gray-900 dark:text-gray-100" style={{ fontFamily: 'serif' }}>
