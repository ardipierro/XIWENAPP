      ...
      <div className="class-manager">
        <div className="manager-header">
          ...
          <div className="header-actions">
            ...
            <button onClick={handleCreateClass} className="btn btn-xs btn-primary">
              + Nueva Clase
            </button>
          </div>
        </div>
                ...
                <div key={index} className={`calendar-day-column ${isToday ? 'today' : ''}`}>
                  <div className="calendar-day-header">
                    ...
                    <div className="day-count">
                      {day.instances.length} {day.instances.length !== 1 ? 'clases' : 'clase'}
                    </div>
                  </div>
                  <div className="calendar-day-schedules">
                    {day.instances.length === 0 ? (
                      ...
                      day.instances.map(instance => (
                        <div key={instance.id} className="calendar-instance-item">
                          <div className="instance-time">{instance.startTime}</div>
                          <div className="instance-name">{instance.className}</div>
                          <div className="instance-actions">
                            <button
                              className="btn-cancel-instance"
